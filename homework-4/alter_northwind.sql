...
ALTER TABLE products ADD CONSTRAINT chk_products_discontinued CHECK (discontinued = 1)

-- 3. Создать новую таблицу, содержащую все продукты, снятые с продажи (discontinued = 1)
SELECT product_name, discontinued INTO discontinued FROM products WHERE discontinued = 1
